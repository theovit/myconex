...
**Why:** hardware.py is the installer's single source of truth for Ollama model selection per tier; a mismatch causes nodes to pull stale models at install time.
